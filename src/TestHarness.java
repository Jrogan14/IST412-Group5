...
import src.Controller.AdminAuth;
import src.Controller.UpdatePassword;
import src.View.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean updatePasswordResult = UpdatePassword.updatePassword(userUsername, userPassword, "newPassword");
